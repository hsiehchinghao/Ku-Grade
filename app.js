...
//讓整個網站的enter key都無法使用(資料不會回傳至後台)
...
//改變credit之後，GPA也要更新 (這裡是Nodelist，所以後面新增的元素不會跟進其addEventlistner)
...
function changeColor(target) {
  if (target.value == "F") {
    ...
    target.style.backgroundColor = "#94d40d";
    target.style.color = "white";
  }
}
